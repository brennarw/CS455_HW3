...
//approach: have a different reducer for each attribute to include
//then each reducer sums up the values, finds the average then writes that to the final output
public class QuestionSevenMain {
    
    private Job job;
    private String input;
    private String output;

    public QuestionSevenMain(Job job, String input, String output){
        this.job = job;
        this.input = input;
        this.output = output;
    }
